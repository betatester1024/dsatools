...
var Ht = (n, t, e) => t in n ? Nt(n, t, { enumerable: true, configurable: true, writable: true, value: e }) : n[t] = e;
...
`, ue = {
  ...
  destroy(n = false) {
    ...
    return this.mounted && (this.emit("beforeDestroy", this), s.abort(), this.destroyModules(), n && e && (this.reset(), e.removeAttribute("style")), t[_] = null, this.mounted = false, this.emit("destroy", this)), null;
  },
  update(n) {
    const { element: t, controller: e } = this;
    return this.emit("beforeUpdate", this), t[_] = null, this.mounted = false, e.abort(), this.destroyModules(), n && (this.options = Object.assign({}, Ot, bt(n) && n)), this.init(), this.emit("update", this), this;
  },
  getImageData() {
...
class me {
  ...
  destroySlider() {
    ...
    e === `.${I}` ? (c = t.sliderEl) == null || c.remove() : (r = t.sliderTrack) == null || r.remove(), s == null || s.abort(), t.mounted = false;
  }
  // destroy zoomer
  destroyZoomer() {
    ...
    ].forEach((m) => f(m.target, m.className, m.el)), r == null || r.abort(), t.mounted = false;
  }
}
V = /* @__PURE__ */ new WeakSet(), wt = function() {
  ...
  L(e, {
    ...
    translateX: 0,
    translateY: 0
  }), t.classList.add(Vt), this.mounted = true, this.emit("ready", this);
}, U = /* @__PURE__ */ new WeakSet(), Xt = function() {
  ...
  if (z && (i || c)) {
    i && (this.states.dragging = false), c && (this.states.pinching = false);
  ...
  const r = (a) => {
    a && a.button !== 0 || (v(i, {
      startX: w(a).clientX,
      startY: w(a).clientY
    }), this.states.dragging = true, this.emit("dragStart", this, { x: s.translateX, y: s.translateY }, a), document.addEventListener(M, l), document.addEventListener(x, o));
  }, l = (a) => {
    ...
    a.touches || (this.states.dragging = false, this.emit("dragEnd", this, { x: s.translateX, y: s.translateY }, a), document.removeEventListener(M, l), document.removeEventListener(x, o));
  };
  r(t);
}, j = /* @__PURE__ */ new WeakSet(), Dt = function(t) {
  ...
  const d = (h) => {
    ...
    v(o, {
      ...
      widthDiff: T,
      heightDiff: b
    }), r && (this.states.dragging = true, this.emit("dragStart", this, { x: s.translateX, y: s.translateY }, h)), l && u.length === 2 && (this.states.pinching = true, this.emit("pinchStart", this, s.scale, h)), document.addEventListener("touchmove", f), document.addEventListener("touchend", m);
  }, f = (h) => {
    const u = h.touches;
    if (!u)
      return;
    ...
    if (p && u.length === 2 && this.zoomTo(tt, false), g) {
    ...
    if (g && !u.length && (this.states.dragging = false, this.emit("dragEnd", this, { x: s.translateX, y: s.translateY }, h)), p && u.length < 2 && (this.states.pinching = false, this.emit("pinchEnd", this, s.scale, h)), g && u.length === 1) {
  ...
  d(t);
}, G = /* @__PURE__ */ new WeakSet(), Lt = function() {
...
}, P = /* @__PURE__ */ new WeakSet(), yt = function() {
  const { slider: t, zoomer: e } = this.__modules__;
  t && S(this, F, At).call(this), e && S(this, K, $t).call(this);
}, F = /* @__PURE__ */ new WeakSet(), At = function() {
  ...
  r.classList.add(`${I}-${i}`), N(e, "value", {
    ...
    sliderTrack: l,
    sliderButton: a
  }), S(this, q, It).call(this), l.append(o, a), r.append(l), c && t.append(r), e.mounted = true;
  ...
  const o = i === "vertical", a = (h) => {
    ...
    this.emit("slideEnd", this, this.getSliderValue(), h), s.sliding = false, document.removeEventListener(M, f), document.removeEventListener(x, m);
  };
  r.addEventListener(Jt, d, { signal: c == null ? void 0 : c.signal });
}, K = /* @__PURE__ */ new WeakSet(), $t = function() {
  ...
  v(e, {
    ...
    zoomerOutEl: f,
    zoomerResetEl: m
  }), a && (d && a.append(d), f && a.append(f), m && a.append(m), s === `.${Z}` && t.append(a)), S(this, J, Ct).call(this), e.mounted = true;
